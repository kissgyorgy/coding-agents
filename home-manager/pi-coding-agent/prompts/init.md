---
description: Initialize an AGENT.md file with codebase documentation
---
Please analyze this codebase and create an AGENT.md file, which will be given to future instances of the coding agent to operate in this repository.
